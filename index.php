<?php
	...
	$social['message'] = "Choose your fast food by The Prize Inside.";
	$social['description'] = "The Prize Inside is all about kids meal prizes. Use the app to see what prizes are available and find the closest restaurant. Also use the app to turn your prize into artwork! Share it in the gallery and on social networks. Choose your fast food by The Prize Inside.";
...
<html>
	<head>
		...
		<meta name="twitter:app:id:googleplay" content="com.greenzeta.theprizeinside">
...
<div id="footer">
	...
	<a id="gzlink" href="http://apps.greenzeta.com" target="_blank" style="display: block; position: fixed; bottom: 0px; right: 0px; margin: 0px; padding: 0px; height: auto; width: 40%; max-width: 300px; min-width: 200px; z-index: 1000;">
