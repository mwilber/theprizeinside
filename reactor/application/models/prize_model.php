...
class Prize_Model extends CI_Model
{
	var $table = "tblPrize";
	var $pk = "prizeId";
	var $ds = "prizeTimeStamp";  //Default sortby field 
	var $rq = "prizeName";		//Required field (you'll need to mod the form validation if there isn't one)
	var $fields = array(
		 'prizeName' => array('label'=>'Name','type'=>'varchar','constraint'=>100),
		 'prizeImage' => array('label'=>'Image','type'=>'varchar','constraint'=>200),
		 'prizeGender' => array('label'=>'Gender','type'=>'varchar','constraint'=>1),
		 'prizeLink' => array('label'=>'Link','type'=>'varchar','constraint'=>200),
		 'prizeActive' => array('label'=>'Active','type'=>'int'),
