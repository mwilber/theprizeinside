			...
			<nav>
				<ul>
					<? if( $this->session->userdata('userEmail') ): ?>
						<!-- Add nav elements here --><li><a href="<?= base_url() ?>checkin" class="checkin">Checkin</a></li><li><a href="<?= base_url() ?>profile" class="profile">Profile</a></li><li><a href="<?= base_url() ?>auth" class="auth">Auth</a></li><li><a href="<?= base_url() ?>review" class="review">Review</a></li><li><a href="<?= base_url() ?>restaurant" class="restaurant">Restaurant</a></li><li><a href="<?= base_url() ?>prize" class="prize">Prize</a></li>
